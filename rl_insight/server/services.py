...
class ServerServiceManager:
    ...
    def install_missing_dependencies(
        self, *, force: bool = False, local_archive_dir: str | Path | None = None, planned_releases: list[dict[str, Any]] | None = None
    ) -> list[ServiceStatus]:
        return self.dependencies.install_missing(force=force, local_archive_dir=local_archive_dir, planned_releases=planned_releases)
